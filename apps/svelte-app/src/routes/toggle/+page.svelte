    ...
    <div class="grid gap-4">
      <Card
        ...
        ><div class="grid justify-items-start gap-2">
          <Toggle {pressed} onchange={(value) => (pressed = value)}
            ><span aria-hidden="true">★</span>Favorite</Toggle
          >
      ...
      <Card
        ...
        ><div class="grid gap-2">
          <ToggleGroup
            ...
            onchange={(value) => (alignment = value as string)}
            ><Toggle value="left">Left</Toggle><Toggle value="center"
              >Center</Toggle
      ...
      <Card
        ...
        ><div class="grid gap-2">
          <ToggleGroup
            ...
            onchange={(value) => (formats = value as string[])}
            ><Toggle value="bold"
              ><strong aria-hidden="true">B</strong>Bold</Toggle
            ><Toggle value="italic"><em aria-hidden="true">I</em>Italic</Toggle
            ><Toggle value="underline"
              ><u aria-hidden="true">U</u>Underline</Toggle
            ></ToggleGroup
          >
          <p class="text-sm text-muted-foreground">
      ...
      <Card
        ...
        ><div class="grid gap-3">
          ...
          <div class="flex items-start gap-3">
            <span class="w-20 pt-1.5 text-sm text-muted-foreground"
              >Vertical</span
            ><ToggleGroup
              defaultValue="top"
              orientation="vertical"
              variant="outline"
              ><Toggle value="top">Top</Toggle><Toggle value="center"
                >Center</Toggle
