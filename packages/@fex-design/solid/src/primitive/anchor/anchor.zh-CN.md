...
| 原生属性 | Solid JSX native attributes and refs | — | 原生属性、事件与元素访问。 |
...
| 原生属性 | Solid JSX native attributes and refs | — | 原生 li 属性与事件。 |
...
Primitive 组件提供组合契约；组件私有 context 不作为公开的自定义 UI primitive。
