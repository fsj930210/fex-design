...
@Component({
  ...
  template:
    '<select-simple-demo title="Multi-field search" description="Search label, searchText and keywords." [items]="options" [showSearch]="true" [filterOption]="filter" placeholder="输入 google 或 meta" />',
})
