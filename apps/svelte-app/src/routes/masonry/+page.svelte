<script lang="ts">
  ...
  import CollectionDemo from "./collection-demo.svelte";
  import DynamicDemo from "./dynamic-demo.svelte";
  import ImageDemo from "./image-demo.svelte";
  import ResponsiveDemo from "./responsive-demo.svelte";
  import RtlHiddenDemo from "./rtl-hidden-demo.svelte";
  import StrategyDemo from "./strategy-demo.svelte";
  import VirtualDemo from "./virtual-demo.svelte";
</script>

<svelte:head><title>Masonry</title></svelte:head>
