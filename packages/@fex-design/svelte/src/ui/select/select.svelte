<script lang="ts" generics="TItem extends Record<string, unknown>">
  ...
  import SelectRoot from "../../primitive/select/select-root.svelte";
  import SelectTrigger from "../../primitive/select/select-trigger.svelte";
  import SelectContent from "../../primitive/select/select-content.svelte";
