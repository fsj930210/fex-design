...
## Import
    ...
    import { Avatar, AvatarBadge, AvatarFallback, AvatarGroup, AvatarGroupCount, AvatarImage } from '@fex-design/svelte/primitive/avatar'
...
Components pass through Svelte HTML attributes; use `bind:ref` for element access.
