...
const angularPackagePath = path.join(workspaceRoot, 'packages/@fex-design/components/angular/package.json')
...
const componentPaths = Object.fromEntries(
  Object.entries(angularPackage.exports)
    ...
    .map(([subpath, target]) => [
      ...
      [path.posix.join('packages/@fex-design/components/angular', target.slice(2))],
    ]),
)
