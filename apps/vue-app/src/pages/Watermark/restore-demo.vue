...
function removeWatermark() {
  document.querySelector('[data-demo="vue-watermark-restore"] [data-slot="watermark"]')?.remove()
}
</script>
...
<template>
  <Card title="Restore" description="Removing the generated watermark layer appends it back.">
    <div class="space-y-2">
      <Button variant="outline" @click="removeWatermark">Remove generated layer</Button>
      <Watermark
        :content="['FEX Admin', 'Do not distribute']"
        data-demo="vue-watermark-restore"
