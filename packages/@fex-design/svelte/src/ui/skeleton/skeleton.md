...
| native attributes | `HTMLAttributes<HTMLDivElement>` | — | Passed to the generated root div; class/style merge with root structured options. |
...
The `children` snippet provides real content; the `placeholder` snippet provides a custom skeleton.
