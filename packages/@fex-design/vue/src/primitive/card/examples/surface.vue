...
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from '@fex-design/vue/primitive/card'
</script>
<template>
  <Card
    ...
    ><CardHeader
      ><CardTitle class="text-lg font-bold text-white">三个独立 Surface</CardTitle></CardHeader
