  ...
  <div class="grid gap-4 lg:grid-cols-[280px_minmax(0,1fr)]">
    <div class="grid gap-3">
      <label class="grid gap-1.5 text-sm text-foreground">
        ...
        <InputRoot
          value={content}
          onValueChange={(value: string) => (content = value)}
        >
      ...
      <label class="grid gap-1.5 text-sm text-foreground">
        ...
        <InputRoot
          value={color}
          onValueChange={(value: string) => (color = value)}
        >
      ...
      <div class="grid grid-cols-2 gap-1.5">
        <label class="grid gap-1.5 text-sm text-foreground">
          ...
          <InputRoot
            value={String(gapX)}
            onValueChange={(value: string) => (gapX = numeric(value))}
          >
        ...
        <label class="grid gap-1.5 text-sm text-foreground">
          ...
          <InputRoot
            value={String(gapY)}
            onValueChange={(value: string) => (gapY = numeric(value))}
          >
        ...
        <label class="grid gap-1.5 text-sm text-foreground">
          ...
          <InputRoot
            ...
            onValueChange={(value: string) => (offsetX = numeric(value))}
          >
        ...
        <label class="grid gap-1.5 text-sm text-foreground">
          ...
          <InputRoot
            ...
            onValueChange={(value: string) => (offsetY = numeric(value))}
          >
    ...
    >
      <div
        class="grid min-h-96 place-items-center p-4 text-center text-sm text-muted-foreground"
      >
