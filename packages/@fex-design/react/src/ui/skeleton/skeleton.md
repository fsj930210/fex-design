...
## Import
    ...
    import { Skeleton, SkeletonAvatar, SkeletonBlock, SkeletonButton, SkeletonImage, SkeletonInput, SkeletonText } from '@fex-design/react/ui/skeleton'
...
| styles | SkeletonStyles<`CSSProperties`> | — | Inline styles for root, avatar, title, and paragraph. |
| native attributes | `ComponentProps<'div'>` | — | Passed to the generated root div; class/style merge with root structured options. |
...
`children` provides real content; the `placeholder` prop provides a custom skeleton.
