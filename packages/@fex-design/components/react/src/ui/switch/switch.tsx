...
export function Switch({
  ...
  return (
    ...
    >
      {checkedContent != null && (
        <SwitchContent state="checked" className={classNames?.content} style={styles?.content}>
          {checkedContent}
        </SwitchContent>
      )}
      {uncheckedContent != null && (
        <SwitchContent state="unchecked" className={classNames?.content} style={styles?.content}>
          {uncheckedContent}
        </SwitchContent>
      )}
      <SwitchThumb className={classNames?.thumb} style={styles?.thumb}>
