...
import DataTableDemo from './data-table-demo.vue'
import TreeDemo from './tree-demo.vue'
</script>
    ...
    <div class="mx-auto w-full max-w-5xl space-y-4">
      <header class="space-y-2">
        ...
        <div>
          ...
          <p class="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
            Right-click primitive based on pointer virtual references. Trigger slot props bind to
      ...
      <div class="space-y-4">
        <Card
          ...
          description="Trigger slot props bind directly to the caller element; no wrapper is inserted."
        >
          <BasicDemo />
        </Card>
        <Card
