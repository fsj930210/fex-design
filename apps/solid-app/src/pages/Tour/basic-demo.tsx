...
export function BasicDemo() {
  return (
    <Card title="基本 / 非受控" description="通过 TourStep 组合注册步骤，不使用 steps 数组。">
      <TourRoot>
        ...
        <TourPortal>
          <TourOverlay />
          <TourStep name="basic-first" target="basic-first">
            <TourContent>
              <TourArrow />
          ...
          <TourStep name="basic-second" target="basic-second">
            <TourContent>
              <TourArrow />
              <TourPanel title="第 2 步" description="步骤通过组合式 primitive 注册。">
                <DefaultTourActions />
              </TourPanel>
            </TourContent>
          </TourStep>
