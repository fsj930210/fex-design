...
@Component({
  selector: 'checkbox-primitive-controlled-example',
  standalone: true,
  imports: [Button, CheckboxRoot, CheckboxControl, CheckboxIndicator, CheckboxLabel],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './controlled.html',
})
export class CheckboxPrimitiveControlledExample {
