  ...
  return (
    <MasonryRoot
      ...
      onLayoutChange={(layout: MasonryLayoutDetail) =>
        setColumns(
          Object.fromEntries(layout.items.map((item) => [String(item.key), item.column + 1])),
        )
      }
    >
      <MasonryViewport>
