...
export class SelectFieldNamesExample { readonly options = [{ profileId: 1, displayName: '张三' }, { profileId: 2, displayName: '李四', disabled: true }]; readonly fields = { value: 'profileId', label: 'displayName' } as const }
