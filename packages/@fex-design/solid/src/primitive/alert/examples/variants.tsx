...
export default function Variants(){return <div class="grid w-full gap-3">{variants.map(([variant,title])=><Alert variant={variant}><AlertIcon><InfoIcon/></AlertIcon><AlertTitle>{title}</AlertTitle></Alert>)}</div>}
