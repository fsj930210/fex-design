...
export function HorizontalDemo() {
  ...
  return <Card title="Horizontal" description="Horizontal anchors use the same tracking behavior.">
    <Anchor orientation="horizontal" activeOffset={80} container={() => container ?? window} items={[
