...
export class Popover extends PrimitivePopover {
  ...
  readonly contentTemplate = computed(() =>
    this.content() instanceof TemplateRef
      ? (this.content() as TemplateRef<{ open: boolean; close: () => void }>)
      : null,
  )
...
export { PopoverTrigger } from '@fex-design/angular/primitive/popover/popover-trigger'
export { createPopover } from '@fex-design/angular/primitive/popover/create-popover'
export type {
  PopoverOptions,
  PopoverClassNames,
  PopoverSemanticPart,
