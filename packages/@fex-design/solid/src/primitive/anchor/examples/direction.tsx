            ...
            >
              <div class="grid min-h-full grid-cols-[8rem_minmax(0,1fr)] gap-6 p-4">
                  ...
                  <AnchorRoot container={() => container()!} class="mt-3">
                    ...
                    <AnchorList>
                      <AnchorItem
                        ...
                        target={`#solid-${direction}-overview`}
                      >
                        <AnchorLink>{rtl ? 'نظرة عامة' : '概览'}</AnchorLink>
                      </AnchorItem>
                      <AnchorItem value={`${direction}-usage`} target={`#solid-${direction}-usage`}>
                        <AnchorLink>{rtl ? 'طريقة الاستخدام' : '使用方式'}</AnchorLink>
                        <AnchorList>
                          <AnchorItem value={`${direction}-api`} target={`#solid-${direction}-api`}>
                            <AnchorLink>{rtl ? 'واجهة البرمجة' : 'API'}</AnchorLink>
                          </AnchorItem>
                        </AnchorList>
                      </AnchorItem>
                    </AnchorList>
                ...
                <div class="grid gap-32 pb-64">
                  ...
                  <section id={`solid-${direction}-usage`}>
                    {rtl ? 'طريقة الاستخدام' : '使用方式'}
                  </section>
