...
<main class="min-h-screen bg-secondary-background px-2 md:px-6 py-4">
  <div class="mx-auto w-full max-w-5xl space-y-4">
    <header class="space-y-4">
      ...
      <div>
        ...
        <p class="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          Primitive modal composition backed by the shared core overlay
          controller.
        </p>
      </div>
    </header>
    ...
    <div class="space-y-4">
      <Card
        title="Primitive"
        description="Trigger exposes snippet props and content owns ARIA labels."
      >
            ...
            <DialogTrigger>
              {#snippet children(slot)}
                <Button
                  ...
                  onclick={slot.props.onclick}>Open dialog</Button
                >
              {/snippet}
            </DialogTrigger>
            <DialogPortal>
              ...
              <DialogContent>
                ...
                <DialogHeader>
                  ...
                  <DialogDescription
                    >Review the record before archiving it.</DialogDescription
                  >
                </DialogHeader>
                <DialogBody
                  >The shared controller handles open state, mounted phase,
                  Escape, and top-layer dismiss.</DialogBody
                >
                <DialogFooter>
                  <DialogClose>
            ...
            <DialogTrigger>
              {#snippet children(slot)}
                <Button
                  ...
                  variant="outline">{open ? "Open" : "Closed"}</Button
                >
              {/snippet}
            </DialogTrigger>
            <DialogPortal>
              ...
              <DialogContent>
                ...
                <DialogHeader>
                  ...
                  <DialogDescription
                    >The parent owns the open state.</DialogDescription
                  >
                </DialogHeader>
                <DialogBody
                  >Overlay click and Escape request closing through the
                  controlled callback.</DialogBody
                >
                <DialogFooter>
                  <DialogClose>
                    {#snippet button(props)}
      ...
      <Card
        title="Sizes"
        description="Content size is a primitive style variant."
      >
        <div class="flex min-w-0 flex-wrap items-center gap-2">
            ...
            <Dialog>
              ...
              <DialogPortal>
                ...
                <DialogContent {size}>
                  ...
                  <DialogBody
                    >The size prop only changes content width.</DialogBody
                  >
                  <DialogFooter>
                    <DialogClose>
                      {#snippet button(props)}
      ...
      <Card
        title="Dismiss"
        description="Overlay pointer dismissal can be disabled."
      >
        <div class="flex min-w-0 flex-wrap items-center gap-2">
            ...
            <DialogTrigger>
              {#snippet children(slot)}
                <Button
                  ...
                  data-state={slot.props["data-state"]}
                  onclick={slot.props.onclick}
                  variant="outline">No overlay close</Button
                >
              {/snippet}
            </DialogTrigger>
            <DialogPortal>
              ...
              <DialogContent>
                ...
                <DialogBody
                  >Use the footer actions or Escape to close.</DialogBody
                >
                <DialogFooter>
                  <DialogClose>
                    {#snippet button(props)}
