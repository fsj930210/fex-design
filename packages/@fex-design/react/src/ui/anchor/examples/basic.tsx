...
const items = [
  { key: 'overview', title: '概览', target: '#react-ui-basic-overview' },
  {
    key: 'usage',
    title: '使用方式',
    target: '#react-ui-basic-usage',
    children: [{ key: 'api', title: 'API', target: '#react-ui-basic-api' }],
  },
]
