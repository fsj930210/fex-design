<script lang="ts">
  import ChangeMetaDemo from "./change-meta-demo.svelte";
  ...
  import LocalSearchDemo from "./local-search-demo.svelte";
  import MaxCountDemo from "./max-count-demo.svelte";
  import MultiFieldSearchDemo from "./multi-field-search-demo.svelte";
  import MultipleDemo from "./multiple-demo.svelte";
  import PopupRenderDemo from "./popup-render-demo.svelte";
