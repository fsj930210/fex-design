...
<Drawer
  ><DrawerTrigger
    >{#snippet children(props)}<Button {...props}>Open parent</Button
      >{/snippet}</DrawerTrigger
  ><DrawerPortal
    ><DrawerMask /><DrawerContent aria-label="Parent drawer"
      ><DrawerHeader>Parent<DrawerClose /></DrawerHeader><DrawerBody
        ><Drawer size="sm"
          ><DrawerTrigger
          ...
          ><DrawerPortal
            ><DrawerMask /><DrawerContent size="sm" aria-label="Nested drawer"
              ><DrawerHeader>Nested<DrawerClose /></DrawerHeader><DrawerBody
                >Top-layer dismissal remains scoped to the nested drawer.</DrawerBody
              ></DrawerContent
            ></DrawerPortal
          ></Drawer
        ></DrawerBody
