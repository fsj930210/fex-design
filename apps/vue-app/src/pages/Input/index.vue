...
const controlledValue = ref('fex-design')
      ...
      <div class="grid gap-4">
        ...
        <Card
          ...
          ><div class="grid gap-3 md:grid-cols-2">
            ...
            <InputRoot default-value="uncontrolled-value"
        ...
        <Card title="Prefix" description="InputPrefix 位于输入框内部、原生输入内容之前。"
          ><InputRoot class="max-w-md"
            ...
            ><InputControl aria-label="用户名" placeholder="username" /></InputRoot
        ></Card>
        ...
        <Card
          ...
          ><InputRoot class="max-w-xl"
            ...
            ><InputControl aria-label="站点地址" placeholder="example" /><InputAddonAfter
              >/console</InputAddonAfter
            ></InputRoot
          ></Card
        >
        <Card title="Clear" description="InputClear 仅在有值且可编辑时显示，清空后恢复输入焦点。"
          ><InputRoot default-value="clearable-value" class="max-w-md"
            ><InputControl aria-label="可清空输入" /><InputClear aria-label="清空输入" /></InputRoot
        ></Card>
        <Card
