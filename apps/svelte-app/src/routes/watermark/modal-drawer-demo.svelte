...
<Card
  ...
  description="Watermark can wrap modal and drawer content."
>
      ...
      <DialogTrigger>
        {#snippet children(slot)}
          <Button
            ...
            onclick={slot.props.onclick}>Open modal</Button
          >
        {/snippet}
      </DialogTrigger>
      <DialogPortal>
        ...
        <DialogContent aria-label="Watermarked modal">
          <Watermark content="FEX Admin">
            ...
            <DialogBody class="min-h-36"
              >This modal body is wrapped by Watermark.</DialogBody
            >
            <DialogFooter>
              <DialogClose>
      ...
      <DrawerPortal>
        ...
        <DrawerContent aria-label="Watermarked drawer">
          <Watermark content="FEX Admin">
            ...
            <DrawerBody>
              <div class="min-h-40">
                Drawer content is wrapped by Watermark.
              </div>
            </DrawerBody>
          </Watermark>
        </DrawerContent>
