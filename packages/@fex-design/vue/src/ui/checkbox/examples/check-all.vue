...
<template>
  <div class="grid gap-3">
    <Checkbox :checked="all" :indeterminate="partial" @change="toggleAll">全部权限</Checkbox
    ><CheckboxGroup :value="selected" @change="selected = $event"
      ><Checkbox value="read">读取</Checkbox><Checkbox value="write">编辑</Checkbox
      ><Checkbox value="publish">发布</Checkbox></CheckboxGroup
    >
  </div>
</template>
