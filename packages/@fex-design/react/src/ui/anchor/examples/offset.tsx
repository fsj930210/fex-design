...
const items = [
  { key: 'global', title: '全局偏移 48px', target: '#react-ui-offset-global' },
  { key: 'item', title: '单项覆盖 96px', target: '#react-ui-offset-item', targetOffset: 96 },
]
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-40 pb-64">
        <section id="react-ui-offset-global">
          <h3 className="font-semibold">使用全局偏移</h3>
        </section>
        <section id="react-ui-offset-item">
