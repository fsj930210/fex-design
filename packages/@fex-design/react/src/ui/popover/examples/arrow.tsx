...
export function ArrowExample() {
  return <div className="w-full flex items-center justify-center min-h-[360px] py-16">{(<div className="flex flex-wrap gap-4"><DemoPopover arrow={false} placement="bottomLeft" label="不显示箭头" /><DemoPopover arrow placement="bottomLeft" label="箭头距面板边缘 16px" /><DemoPopover arrow arrowPadding={28} placement="bottomLeft" label="箭头距面板边缘 28px" /></div>)}</div>
}
