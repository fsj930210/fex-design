<script lang="ts">
  ...
  import InputOTPSeparator from "@fex-design/svelte/primitive/input-otp-separator";
  import Card from "@fex-design/svelte/ui/card";
</script>

<Card
  title="多字符分段"
  description="每段可设置不同最大长度，填满前保持当前焦点。"
  ><InputOTPRoot
    ><InputOTPGroup
      ><InputOTPInput
        index={0}
      ...
      /><InputOTPInput
        ...
        aria-label="分行代码"
      /></InputOTPGroup
    ><InputOTPSeparator>/</InputOTPSeparator><InputOTPGroup
      ><InputOTPInput
        index={2}
        maxLength={4}
        class="w-20"
