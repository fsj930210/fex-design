...
| state | 'checked' \| 'unchecked' | — | SwitchContent 的目标状态。 |

## 示例

示例依次为基本展示、Shape、Size、文本和图标、Loading、Disabled、校验失败、受控与非受控、LTR 与 RTL、CSS Variables。受控示例通过外部按钮设置状态。
