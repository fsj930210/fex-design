...
## Import
    ...
    import { Avatar, AvatarBadge, AvatarFallback, AvatarGroup, AvatarGroupCount, AvatarImage } from '@fex-design/angular/primitive/avatar'
...
Components use unprefixed selectors: `avatar`, `avatar-image`, `avatar-fallback`, `avatar-badge`, `avatar-group`, and `avatar-group-count`.
