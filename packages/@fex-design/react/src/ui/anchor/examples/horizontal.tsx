...
const items = [
  { key: 'intro', title: '介绍', target: '#react-ui-horizontal-intro' },
  { key: 'features', title: '功能', target: '#react-ui-horizontal-features' },
  { key: 'api', title: 'API', target: '#react-ui-horizontal-api' },
]
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-24 pt-8 pb-48">
        <section id="react-ui-horizontal-intro">
          <h3 className="font-semibold">介绍</h3>
        </section>
        <section id="react-ui-horizontal-features">
          <h3 className="font-semibold">功能</h3>
        </section>
        <section id="react-ui-horizontal-api">
