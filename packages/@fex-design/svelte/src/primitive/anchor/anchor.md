...
| native attributes | Svelte element attributes and bindable element access | — | Native attributes, events, and element access. |
...
| native attributes | Svelte element attributes and bindable element access | — | Native li attributes and events. |
...
The Primitive components expose the compositional contract; the internal context module is not exported.
