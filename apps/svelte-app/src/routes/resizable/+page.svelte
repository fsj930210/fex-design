<script lang="ts">
  ...
  function startResize(
    ...
    const startPoint =
      options.direction === "horizontal" ? event.clientX : event.clientY;
    const rect = (
...
<main class="min-h-screen bg-secondary-background px-2 md:px-6 py-4">
  <div class="mx-auto w-full max-w-5xl space-y-4">
    ...
    <div class="space-y-4">
          ...
          <button
            ...
            onpointerdown={(event) =>
              startResize(event, {
                ...
                setLayout: (layout) => (horizontalLayout = layout),
              })}
            onkeydown={(event) =>
              resizeByKey(event, {
                direction: "horizontal",
      ...
      <Card
        title="Vertical"
        description="Use a vertical group for stacked panels."
      >
        <div
          ...
          <button
            ...
            onpointerdown={(event) =>
              startResize(event, {
                ...
                setLayout: (layout) => (verticalLayout = layout),
              })}
            onkeydown={(event) =>
              resizeByKey(event, {
                direction: "vertical",
      ...
      >
        ...
        >
          ...
          <button
            aria-label="Resize nested horizontal panels"
            data-resizable-handle
            type="button"
            ...
            onpointerdown={(event) =>
              startResize(event, {
                ...
                layout: () => nestedLayout,
                setLayout: (layout) => (nestedLayout = layout),
              })}
            onkeydown={(event) =>
              resizeByKey(event, {
                direction: "horizontal",
          ...
          >
            ...
            <button
              aria-label="Resize nested vertical panels"
              data-resizable-handle
              type="button"
              ...
              onpointerdown={(event) =>
                startResize(event, {
                  ...
                  setLayout: (layout) => (nestedVerticalLayout = layout),
                })}
              onkeydown={(event) =>
                resizeByKey(event, {
                  direction: "vertical",
      ...
      <Card
        ...
        description="A disabled handle keeps the layout fixed."
      >
        <div
        ...
        >
          ...
          <button
            aria-label="Disabled resize handle"
            data-resizable-handle
            type="button"
            disabled
