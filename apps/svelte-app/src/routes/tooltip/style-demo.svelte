  ...
  <TooltipRoot
    ><TooltipTrigger
      >{#snippet children(slot)}<Button
          {...slot.props}
          {@attach slot.action}
          variant="outline">Custom color</Button
        >{/snippet}</TooltipTrigger
    ><TooltipPortal
      ><TooltipContent
        class="[--tooltip-background:#db2777] [--tooltip-foreground:white]"
        >One variable colors both surfaces<TooltipArrow /></TooltipContent
      ></TooltipPortal
    ></TooltipRoot
  ><TooltipRoot
    ><TooltipTrigger
      >{#snippet children(slot)}<Button
          {...slot.props}
          {@attach slot.action}
          variant="outline">Without arrow</Button
        >{/snippet}</TooltipTrigger
    ><TooltipPortal
      ><TooltipContent>No TooltipArrow is rendered</TooltipContent
      ></TooltipPortal
    ></TooltipRoot
  >
</div>
