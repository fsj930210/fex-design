      ...
      <div class="grid gap-4">
        ...
        >
          <div class="grid justify-items-start gap-2">
            <Toggle :pressed="pressed" @change="pressed = $event"
              ><span aria-hidden>★</span>Favorite</Toggle
            >
        ...
        >
          <div class="grid gap-2">
            <ToggleGroup :value="alignment" aria-label="Text alignment" @change="alignment = $event"
              ><Toggle value="left">Left</Toggle><Toggle value="center">Center</Toggle
              ><Toggle value="right">Right</Toggle></ToggleGroup
            >
        ...
        >
          <div class="grid gap-2">
            <ToggleGroup
              ...
              @change="formats = $event"
              ><Toggle value="bold"><strong aria-hidden>B</strong>Bold</Toggle
              ><Toggle value="italic"><em aria-hidden>I</em>Italic</Toggle
              ><Toggle value="underline"><u aria-hidden>U</u>Underline</Toggle></ToggleGroup
            >
        ...
        >
          <div class="grid gap-3">
            <div class="flex items-center gap-3">
              ...
              ><ToggleGroup default-value="day" size="sm"
                ><Toggle value="day">Day</Toggle><Toggle value="week">Week</Toggle
                ><Toggle value="month">Month</Toggle></ToggleGroup
              >
            </div>
            <div class="flex items-start gap-3">
              <span class="w-20 pt-1.5 text-sm text-muted-foreground">Vertical</span
              ><ToggleGroup default-value="top" orientation="vertical" variant="outline"
                ><Toggle value="top">Top</Toggle><Toggle value="center">Center</Toggle
                ><Toggle value="bottom">Bottom</Toggle></ToggleGroup
              >
            </div>
            <div class="flex items-center gap-3">
              <span class="w-20 text-sm text-muted-foreground">Disabled</span
              ><ToggleGroup default-value="one" disabled
                ><Toggle value="one">One</Toggle><Toggle value="two">Two</Toggle></ToggleGroup
              >
            </div>
          </div>
        </Card>
