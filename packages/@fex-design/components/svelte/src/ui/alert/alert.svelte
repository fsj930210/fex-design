<script lang="ts">
  import type {
    ...
    AlertOptions,
    AlertStyles,
  } from "@fex-design/core/alert/types";
  import {
  ...
  import PrimitiveAlert from '@fex-design/svelte/primitive/alert/alert.svelte';

  interface Props
    extends Omit<HTMLAttributes<HTMLDivElement>, "title">, AlertOptions {
    title?: Snippet;
    description?: Snippet;
    children?: Snippet;
    showIcon?: boolean;
