import { Input, InputPassword, InputSearch } from '@fex-design/react/ui/input'
export function SemanticStylesExample() {
  ...
  return (
    <div className="grid w-full gap-3">
      ...
      <InputSearch
        defaultValue="主题"
        className="[--input-background:#faf5ff] [--input-border-color:#d8b4fe] [--input-ring-color:#9333ea]"
      />
    </div>
  )
}
