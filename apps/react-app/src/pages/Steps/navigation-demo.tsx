...
import { Steps, type StepsChangeMeta, type StepValue } from '@fex-design/react/primitive/steps'
import { Card } from '@fex-design/react/ui/card'
import { StepList } from './step-list'
export function NavigationDemo() {
  const [message, setMessage] = useState('Use click, Enter, Space or arrow keys.')
  return (
    <Card
      title="Navigation"
