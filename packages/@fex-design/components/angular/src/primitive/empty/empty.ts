import {
  ...
  emptyMediaClassName,
  emptyTitleClassName,
} from '@fex-design/components-styles/empty'
...
@Component({
  ...
  host: { '[class]': 'hostClassName()', 'data-slot': 'empty' },
  template: '<ng-content />',
})
export class Empty {
...
@Component({
  selector: 'div[emptyHeader]',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { '[class]': 'hostClassName()', 'data-slot': 'empty-header' },
  template: '<ng-content />',
})
...
@Component({
  selector: 'div[emptyMedia]',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { '[class]': 'hostClassName()', 'data-slot': 'empty-media' },
  template: '<ng-content />',
})
export class EmptyMedia {
  protected readonly hostClassName = createHostClassName(emptyMediaClassName)
}

@Component({
  selector: 'div[emptyTitle]',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { '[class]': 'hostClassName()', 'data-slot': 'empty-title' },
  template: '<ng-content />',
})
...
@Component({
  selector: 'p[emptyDescription]',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { '[class]': 'hostClassName()', 'data-slot': 'empty-description' },
  template: '<ng-content />',
})
...
@Component({
  selector: 'div[emptyContent]',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { '[class]': 'hostClassName()', 'data-slot': 'empty-content' },
  template: '<ng-content />',
})
