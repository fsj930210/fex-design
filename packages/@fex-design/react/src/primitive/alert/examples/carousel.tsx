import { Alert, AlertDescription, AlertIcon } from '@fex-design/react/primitive/alert'
...
export default function Carousel() {
  return (
    <>
      ...
      <Alert type="warning" className="overflow-hidden">
        <AlertIcon><CircleWarningIcon /></AlertIcon>
        <AlertDescription className="alert-marquee overflow-hidden">
          <span className="alert-marquee-track flex w-max">
