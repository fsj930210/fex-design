...
@Component({ selector: 'spinner-overlay-example', standalone: true, imports: [SpinnerContainer], changeDetection: ChangeDetectionStrategy.OnPush, templateUrl: './overlay.html' })
