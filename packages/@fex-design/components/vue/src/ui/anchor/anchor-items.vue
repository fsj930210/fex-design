...
const forwardItemClick = (event: MouseEvent, item: AnchorItemData<string>) =>
...
<template>
  <AnchorList :class="classNames.list" :style="styles.list"
    ><AnchorItem
      ...
      :value="item.key"
      :target="item.target"
      :target-offset="item.targetOffset"
      :class="classNames.item"
      :style="styles.item"
      ><AnchorLink
        :class="classNames.link"
        :style="styles.link"
        @click="emit('itemClick', $event, item)"
      ...
      ><AnchorItems
        ...
        :styles="styles"
        @item-click="forwardItemClick" /></AnchorItem
  ></AnchorList>
</template>
