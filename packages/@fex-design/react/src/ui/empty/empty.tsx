    ...
    >
      {hasHeader ? (
        <EmptyHeader className={classNames?.header} style={styles?.header}>
          {resolvedImage != null ? (
            <EmptyMedia className={classNames?.image} style={styles?.image}>
              {resolvedImage}
            </EmptyMedia>
          ) : null}
          {title != null ? (
            <EmptyTitle className={classNames?.title} style={styles?.title}>
              {title}
            </EmptyTitle>
          ) : null}
          {description != null ? (
            <EmptyDescription className={classNames?.description} style={styles?.description}>
              {description}
            </EmptyDescription>
          ) : null}
        </EmptyHeader>
      ...
      {children != null ? (
        <EmptyContent className={classNames?.content} style={styles?.content}>
          {children}
        </EmptyContent>
      ) : null}
    </PrimitiveEmpty>
