...
## Import
    ...
    import { Skeleton, SkeletonAvatar, SkeletonBlock, SkeletonButton, SkeletonImage, SkeletonInput, SkeletonText } from '@fex-design/vue/ui/skeleton'
...
| styles | SkeletonStyles<`StyleValue`> | — | Inline styles for root, avatar, title, and paragraph. |
| native attributes | Vue div attrs | — | Passed to the generated root div; class/style merge with root structured options. |
...
The default slot provides real content; the `#placeholder` slot provides a custom skeleton.
