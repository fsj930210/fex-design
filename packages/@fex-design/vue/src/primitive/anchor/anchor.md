...
| native attributes | Vue attrs and exposed element refs | — | Native attributes, events, and element access. |
...
| native attributes | Vue attrs and exposed element refs | — | Native li attributes and events. |

## Native parts

AnchorLink is a native button; AnchorList, AnchorRail, and AnchorIndicator retain their native host attributes. Events: `change`; native `click` on AnchorLink.

## Custom UI logic

`useAnchor` is public and provides the framework-native composable for custom Anchor markup.
