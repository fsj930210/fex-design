...
<Card
  ...
  description="bind:this exposes methods for this Collapse instance."
>
  <div class="mb-2 flex flex-wrap gap-1.5">
    <Button
      variant="outline"
      size="sm"
      onclick={() => collapseRef?.expand("security")}>Open security</Button
    >
    <Button
      variant="outline"
      size="sm"
      onclick={() => collapseRef?.toggle("billing")}>Toggle billing</Button
    >
