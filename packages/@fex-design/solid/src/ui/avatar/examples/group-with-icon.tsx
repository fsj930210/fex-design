...
export function GroupWithIconExample() {
  return (
    <AvatarGroup
      maxCount={3}
      renderOverflow={() => (
        <span class="relative inline-flex size-8 shrink-0 items-center justify-center rounded-full bg-muted-background text-muted-foreground ring-2 ring-background [&>svg]:size-4">
          <PlusIcon />
        </span>
      )}
    >
