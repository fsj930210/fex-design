...
## Import
    ...
    import { Tag, TagAction } from '@fex-design/solid/ui/tag'
...
| content | `children?: JSX.Element`; `closeIcon?: JSX.Element` | — | Tag content and optional close icon override. |
| close event | `onClose?: JSX.EventHandler<HTMLButtonElement, MouseEvent>` | — | Reports activation of the generated close button. |
...
Solid uses `children?: JSX.Element`; `closeIcon?: JSX.Element`. This is the framework-native content API; no cross-framework slot abstraction is introduced.
