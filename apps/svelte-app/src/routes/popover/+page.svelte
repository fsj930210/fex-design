<script lang="ts">
  ...
  import { PopoverArrow } from "@fex-design/svelte/primitive/popover";
  import { PopoverContent } from "@fex-design/svelte/primitive/popover";
  import { PopoverDescription } from "@fex-design/svelte/primitive/popover";
  import { PopoverHeader } from "@fex-design/svelte/primitive/popover";
  import { PopoverPortal } from "@fex-design/svelte/primitive/popover";
  import { PopoverTitle } from "@fex-design/svelte/primitive/popover";
    ...
    <header class="space-y-4">
      ...
      <div>
        ...
        <p class="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          鍩轰簬 core floating overlay 鐨?Svelte
            ...
            <PopoverPortal>
              <PopoverContent>
                ...
                <PopoverHeader class="w-64">
                  ...
                  <PopoverDescription
                    >Content uses shared floating variables and data attributes.</PopoverDescription
                  >
                </PopoverHeader>
              </PopoverContent>
            </PopoverPortal>
            ...
            <PopoverTrigger>
              {#snippet children(slot)}
                <button
                  {...slot.props}
                  use:slot.action
                  class={outlineButtonClass}>Click</button
                >
              {/snippet}
            </PopoverTrigger>
            <PopoverPortal>
              <PopoverContent>
                ...
                <PopoverHeader class="w-64">
                  ...
                  <PopoverDescription
                    >The popover opens immediately while positioning stays in
                    CSS variables.</PopoverDescription
                  >
                </PopoverHeader>
              </PopoverContent>
            </PopoverPortal>
            ...
            <PopoverTrigger>
              {#snippet children(slot)}
                <button
                  {...slot.props}
                  use:slot.action
                  class={secondaryButtonClass}>Hover or focus</button
                >
              {/snippet}
            </PopoverTrigger>
            <PopoverPortal>
              <PopoverContent>
                ...
                <PopoverHeader class="w-64">
                  ...
                  <PopoverDescription
                    >Hover and focus share one trigger source model, so they do
                    not close each other incorrectly.</PopoverDescription
                  >
                </PopoverHeader>
              </PopoverContent>
            </PopoverPortal>
            ...
            <PopoverTrigger>
              {#snippet children(slot)}
                <button
                  {...slot.props}
                  use:slot.action
                  class={outlineButtonClass}>Right click</button
                >
              {/snippet}
            </PopoverTrigger>
            <PopoverPortal>
              <PopoverContent>
                <PopoverHeader class="w-64">
                  ...
                  <PopoverDescription
                    >This is still Popover content; future ContextMenu will
                    reuse the same trigger and floating core with Menu.</PopoverDescription
                  >
                </PopoverHeader>
              </PopoverContent>
            </PopoverPortal>
                    ...
                    <PopoverTrigger>
                      {#snippet children(slot)}
                        <button
                          {...slot.props}
                          use:slot.action
                          class={`${outlineButtonClass} w-24`}
                          >{group[0].label}</button
                        >
                      {/snippet}
                    </PopoverTrigger>
                    <PopoverPortal>
                      ...
                      <PopoverPortal>
                        <PopoverContent>
                          ...
                          <PopoverHeader class="w-44">
                            ...
                            <PopoverDescription
                              >Single-axis placements shift; edge placements
                              only flip.</PopoverDescription
                            >
                          </PopoverHeader>
                        </PopoverContent>
                      </PopoverPortal>
            ...
            <PopoverTrigger>
              {#snippet children(slot)}
                <button
                  {...slot.props}
                  use:slot.action
                  class={outlineButtonClass}>sideOffset 18</button
                >
              {/snippet}
            </PopoverTrigger>
            <PopoverPortal>
            ...
            <PopoverTrigger>
              {#snippet children(slot)}
                <button
                  {...slot.props}
                  use:slot.action
                  class={outlineButtonClass}>alignOffset 28</button
                >
              {/snippet}
            </PopoverTrigger>
            <PopoverPortal>
            ...
            <PopoverTrigger>
              {#snippet children(slot)}
                <button
                  {...slot.props}
                  use:slot.action
                  class={outlineButtonClass}>Mount inside dashed box</button
                >
              {/snippet}
            </PopoverTrigger>
            <PopoverPortal>
