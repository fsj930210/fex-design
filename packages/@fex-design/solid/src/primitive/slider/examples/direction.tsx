...
export default function Example() {
  return (
    <div class="grid w-full max-w-xl gap-6">
      ...
      <section><p>Reverse</p><PrimitiveSlider defaultValue={30} reverse /></section>
      <div class="flex h-48 gap-12">
        <section class="grid gap-2"><p>垂直</p><PrimitiveSlider orientation="vertical" defaultValue={35} /></section>
        <section class="grid gap-2"><p>垂直 Reverse</p><PrimitiveSlider orientation="vertical" reverse defaultValue={35} /></section>
      </div>
    </div>
  )
}
