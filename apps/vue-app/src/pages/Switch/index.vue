      ...
      <div class="space-y-4">
        ...
        <Card title="Sizes" description="Switch supports sm, md, and lg sizes."
          ><div class="flex items-center gap-2">
            ...
            ><SwitchRoot default-checked aria-label="Default switch"
              ><template #default="{ checked: currentChecked }"
                ><SwitchThumb :checked="currentChecked" /></template></SwitchRoot
            ><SwitchRoot size="lg" default-checked aria-label="Large switch"
              ><template #default="{ checked: currentChecked }"
                ><SwitchThumb size="lg" :checked="currentChecked" /></template
            ></SwitchRoot></div
        ></Card>
        <Card title="Disabled" description="Disabled state blocks interaction."
          ><div class="flex items-center gap-2">
            <SwitchRoot disabled aria-label="Disabled switch"
              ><template #default="{ checked: currentChecked }"
                ><SwitchThumb :checked="currentChecked" /></template></SwitchRoot
            ><SwitchRoot disabled default-checked aria-label="Disabled checked switch"
              ><template #default="{ checked: currentChecked }"
                ><SwitchThumb :checked="currentChecked" /></template
            ></SwitchRoot></div
        ></Card>
