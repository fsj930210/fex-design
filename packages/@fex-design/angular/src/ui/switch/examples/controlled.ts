...
@Component({ selector: 'switch-controlled-example', standalone: true, imports: [Switch, Button], changeDetection: ChangeDetectionStrategy.OnPush, templateUrl: './controlled.html' })
