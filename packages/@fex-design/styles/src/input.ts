...
export const inputRootClassName = cva(inputBaseClassName, {
  variants: {
    ...
    size: {
      sm: '[--input-height:var(--input-height-sm,var(--height-sm))] [--input-icon-size:var(--input-icon-size-sm,0.75rem)] [--input-clear-icon-size:0.75rem] px-2 py-0 text-xs',
      md: '[--input-height:var(--input-height-md,var(--height-md))] [--input-icon-size:var(--input-icon-size-md,var(--icon-size-md))] [--input-clear-icon-size:1rem]  px-3 py-1 text-sm',
      lg: '[--input-height:var(--input-height-lg,var(--height-lg))] [--input-icon-size:var(--icon-size-lg,1.25rem)] [--input-clear-icon-size:1.25rem] px-4 py-1.5 text-base',
    },
  },
...
export const inputControlClassName = [
  'min-w-0 flex-1 bg-transparent text-inherit outline-none',
...
export const inputPrefixClassName =
  'flex shrink-0 items-center text-muted-foreground empty:hidden [&_svg]:size-(--input-icon-size)'
...
export const inputClearClassName = [
  'invisible flex shrink-0 items-center justify-center bg-transparent text-muted-foreground opacity-0 outline-none transition-[color,opacity]',
...
export const inputActionClassName = [
  'inline-flex shrink-0 cursor-pointer items-center justify-center bg-transparent text-muted-foreground outline-none transition-colors hover:text-foreground',
