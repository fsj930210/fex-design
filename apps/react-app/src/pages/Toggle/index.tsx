        ...
        <div className="grid gap-4">
          ...
          >
            <div className="grid gap-2">
              ...
              >
                <FormatToggle value="bold" mark={<strong>B</strong>}>
                  Bold
                </FormatToggle>
                <FormatToggle value="italic" mark={<em>I</em>}>
                  Italic
                </FormatToggle>
                <FormatToggle value="underline" mark={<u>U</u>}>
                  Underline
                </FormatToggle>
              </ToggleGroup>
              <p className="text-sm text-muted-foreground">
          ...
          >
            <div className="grid gap-3">
              <div className="flex items-center gap-3">
                <span className="w-20 text-sm text-muted-foreground">Compact</span>
              ...
              <div className="flex items-start gap-3">
                <span className="w-20 pt-1.5 text-sm text-muted-foreground">Vertical</span>
