...
<template>
  <Breadcrumb class="p-1"
    ><BreadcrumbList class="w-max items-center gap-0 overflow-hidden"
      ...
      ><BreadcrumbItem
        ><BreadcrumbPage
          class="inline-flex items-center gap-0.5 px-4 text-sm leading-[2.15] bg-muted-background hover:bg-hover-background parallelogram-breadcrumb"
          >Quarterly plan</BreadcrumbPage
        ></BreadcrumbItem
      ></BreadcrumbList
    ></Breadcrumb
  >
