...
import { ClockIcon } from '@fex-design/vue/icon/clock'
import {
  Timeline,
  TimelineContent,
  TimelineIndicator,
  ...
  <Card
    ...
    ><Timeline
      ><TimelineItem status="completed" class="[--timeline-indicator-size:2rem]"
        ...
        ><TimelineIndicator class="!self-center shadow-sm"><CheckIcon /></TimelineIndicator
